export const HOTEL_CONFIG = {
  ...
  contact: {
    ...
    email: "stay@lhorizon.com",
    address: "102 Ocean Drive, Malibu, CA 90265",
  ...
  seo: {
    title: "L'Horizon — Sanctuary Between the Tides | Luxury Hotel Malibu",
    description: "Experience unparalleled luxury at L'Horizon. A coastal sanctuary in Malibu offering world-class rooms, dining, and ocean views. Book your escape today.",
  },
} as const;
